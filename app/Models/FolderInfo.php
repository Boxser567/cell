...
class FolderInfo extends BaseModel
{
    ...
    public
    static function getCountByOrgId(
        $org_id
    )
    {
    ...
    public
    static function updateValidateTime(
    ...
    public
    static function getCountByGroup(
        $group_id
    )
    {
